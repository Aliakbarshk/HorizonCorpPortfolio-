...
const HoloCard = ({ children }: { children?: React.ReactNode }) => {
  ...
  return (
    ...
    >
      <div
        ref={cardRef}
        className={`relative transition-transform duration-100 ease-out transform-style-3d ${
            ...
            <HoloCard>
              <div className="relative w-80 h-96 rounded-3xl bg-black/40 backdrop-blur-md border border-white/10 overflow-hidden shadow-[0_0_60px_-10px_rgba(37,99,235,0.3)] group">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                  ...
                  <h3 className="text-3xl font-black text-white tracking-tight mb-2 group-hover:text-blue-400 transition-colors">
                    SHAIKH ALIAKBAR
                  </h3>
                ...
                <div className="animate-fade-in space-y-8">
                  <div className="relative pl-6 border-l-2 border-blue-500/30">
                    <p className="text-xl text-gray-300 leading-relaxed font-light mb-6">
                      ...
                      Hello, I'm{" "}
                      <strong className="text-white">Shaikh Aliakbar</strong>. I
                      founded Horizon Corp to dismantle the barrier between
                      imagination and industrial-scale execution.{" "}
                      <span className="text-blue-400 font-bold">
                        &lt;/Init&gt;
                      </span>
                    </p>
                    <p className="text-lg text-gray-400 leading-relaxed">
                      I don't just build software; I engineer{" "}
                      <span className="text-white font-medium">ecosystems</span>
                      . From AI-driven content pipelines to high-performance web
                      architectures, my mission is to automate the mundane so
                      humanity can focus on the extraordinary.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      ...
                      >
                        <trait.icon
                          className={`w-6 h-6 ${trait.color} transition-transform group-hover:rotate-12`}
                        />
